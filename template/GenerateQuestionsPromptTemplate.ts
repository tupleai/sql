...
Please generate ${n} distinct questions based on the given information, including ${Math.floor(
      n / 2
    )} from the perspective of developers and ${Math.ceil(
      n / 2
    )} from the perspective of investors. These questions should be easy to answer with a SQL query and and should cover a range of topics, including specific repos, technical domains, and global trends,less than 25 words. Do not show perspective or sql or classification.
